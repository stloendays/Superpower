...
/**
 * Deterministic local router for reducing large tool catalogs before model context
 * injection. It intentionally has no model, embedding, DOM, or browser dependency.
 */
